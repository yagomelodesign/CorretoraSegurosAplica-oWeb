<%-- 
    ...
    Created on : 31/08/2022, 10:54:11
    Author     : 12046386671
--%>
...
<script>
    function enviar(par) {
        if (par == 'cadastrar') {
            ...
            if (document.cadastro.usuarioLogin.value == '') {
                document.cadastro.mensagem.value = 'Preencha o campo Usuário';
            } else if (document.cadastro.senhaLogin.value == '') {
                document.cadastro.mensagem.value = 'Preencha o campo Senha';
            }else {
                document.cadastro.opcao.value = 'cadastrar';
                document.cadastro.action = 'CAELogin.jsp';
                document.cadastro.submit();
            }
        } else if (par == 'cancelar') {
            document.cadastro.opcao.value = 'cadastrar';
            document.cadastro.usuarioLogin.value = '';
            document.cadastro.senhaLogin.value = '';
            document.cadastro.action = 'CadastroLogin.jsp';
            document.cadastro.submit();
            /// }
        } else if (par == 'alterar') {
...
<html>
    ...
    <body class="container-fluid">
            ...
            <h1 class="titulo1">Cadastro Login</h1>
            ...
            <form class="forms" name="cadastro">
                ...
                <div class="grupo row">
                    ...
                    <label class="titulos2">Usuário: </label>
                    <input class="caixas" type="text" name="usuarioLogin" value="<%= (usuarioLogin == null) ? "" : usuarioLogin%>" size="30" /> 
                    </div>
                    <div class="campos col-lg-4 col-sm-6">
                    <label class="titulos2">Senha: </label>
                    <input class="caixas" type="text" name="senhaLogin" value="<%= (senhaLogin == null) ? "" : senhaLogin%>" size="30" />
                    </div>
                    </div>
                ...
                <% }%>
                <input type="hidden" name="idLogin" value ="<%= (idLogin== null) ? "" : idLogin%>" />
