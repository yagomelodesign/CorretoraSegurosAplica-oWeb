<%-- 
    ...
    Created on : 24/09/2022, 00:08:43
    Author     : trist
--%>
...
<script>
    function enviar(par) {
        if (par == 'cadastrar') {
            ...
            if (document.cadastro.cargoFuncionario.value == '') {
            ...
            document.cadastro.opcao.value = 'cadastrar';
            document.cadastro.cargoFuncionario.value = '';
...
<html>
    ...
    <body class="container-fluid">
            ...
            <h1 class="titulo1">Cadastro Funcionarios</h1>
            ...
            <form class="forms" name="cadastro">
                ...
                <div class="grupo row">
                    ...
                    <label class="titulos2">Cargo:</label>
                    <input class="caixas" type="text" name="cargoFuncionario" value="<%= (cargoFuncionario == null) ? "" : cargoFuncionario%>" size="30" /> 
                    </div>
                    <div class="campos col-lg-4 col-sm-6">
                    <label class="titulos2">Salário:</label>
                    <input class="caixas" type="text" name="salarioFuncionario" value="<%= (salarioFuncionario == null) ? "" : salarioFuncionario%>" size="30" />
                    </div>
                ...
                <% }%>
                <input type="hidden" name="idFuncionario" value ="<%= (idFuncionario == null) ? "" : idFuncionario%>" />
